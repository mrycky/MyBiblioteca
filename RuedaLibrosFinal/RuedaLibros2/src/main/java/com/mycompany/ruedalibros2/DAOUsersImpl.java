...
public class DAOUsersImpl extends Conexion implements DAOUsers{
    ...
    public void modificar(usuarios user) throws Exception {
           ...
           // st.setInt(9, user.getSancion());
            //st.setInt(10, user.getSancion_dinero());
        ...
        try{
            ...
            while(rs.next()){
                ...
                else
                {
                    ...
                    user.setDate(rs.getDate("edad"));
                      
                }

                 user.setEstado_civil("estado_civil");
